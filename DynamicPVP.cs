...
namespace Oxide.Plugins
{
    ...
    public class DynamicPVP : RustPlugin
    {
        ...
        {
            // Declare baseEvent variable outside of the if statement
            ...
            if (zoneAdded)
            {
				...
				// Create marker using MarkerManager2
				string markerName = $"DynamicPVP_{zoneId}"; // Unique marker name based on zoneId
				float markerDuration = 0f; // Set to 0 for indefinite duration
				float markerRadius = 2f; // Set the radius of the marker
				string markerText = "DynamicPVP Zone"; // Text to display on the marker
				string markerColor = "00FFFF"; // Marker color (HEX format)
				string markerIcon = "marker"; // Marker icon (available icons: marker, home, trade, etc.)

				// Call the MarkerManager2 plugin to create the marker
				MarkerManager2.Instance.CreateMarker(markerName, position, markerDuration, markerRadius, markerText, markerColor, markerIcon);
        ...
        private bool DeleteDynamicZone(string zoneId)
        {
			...
			// Delete marker using MarkerManager2
			string markerName = $"Marker_{zoneId}"; // Set the unique name of the marker to remove
			MarkerManager2.Instance.API_RemoveMarker(markerName);
